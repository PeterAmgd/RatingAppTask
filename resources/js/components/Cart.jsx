        ...
        Swal.fire({
            ...
            <div class="swal-form">
              <div class="swal-row">
                ...
                <input type="text" id="amount" name="amount" value="${this.getTotal(this.state.cart)}">
              </div>
              <div class="swal-row">
                <label for="input1">today</label>
                <input type="date" id="input1" name="input1" required>
              </div>
              <div class="swal-row">
                <label for="input2">delivery date</label>
                <input type="date" id="input2" name="input2" required>
              </div>
              <div class="swal-row">
          ...
          `,
            ...
            preConfirm: (amount) => {
                ...
                const today = document.getElementById('input1').value;
                const delivery_date = document.getElementById('input2').value;
                const due_date = document.getElementById('input3').value;
                return axios
                    .post("/admin/orders", {
